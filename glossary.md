...
* The pre-install-toolkit (PIT) refers to the running environment used for CSM installations and recovery. Example: "Once in the PIT, proceed with the pre-installation," means once the user is in the environment provided by the LiveCD they can proceed with their procedure. 
