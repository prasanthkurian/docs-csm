...
Session template can be created by via the API by providing JSON data, or via the CLI by writing the JSON data to a file, which can be referenced using the `--file` parameter.
